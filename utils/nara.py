...
관련 기준 (아래 중 하나라도 해당하면 포함):
- 영상 제작 / 콘텐츠 제작 / 미디어 제작
- 홍보 프로그램 기획·제작 (·특수문자 포함 여부 무관)
- 방송 제작 / 방송 관련 제작
- SNS / 유튜브 / 디지털 미디어 운영·콘텐츠
- 홍보 대행 / 홍보 운영
- 스포츠·문화 홍보 프로그램
- 프로그램 제작 (기획, 연출, 편집 포함)
- 기획·제작이 포함된 모든 공고

※ 중요: 판단이 애매한 경우 반드시 포함(relevant)으로 처리하세요.
   공고명에 홍보, 제작, 기획, 영상, 콘텐츠, 방송 중 하나라도 포함되면 관련 공고로 분류하세요.
   과도하게 제외하는 것보다 넓게 포함하는 것이 낫습니다.
