...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
【품질 기준 — 최우선 준수】
각 항목은 최소 300자 이상, 구체적 수치와 출처 포함, ## 소제목으로 구분하여 작성.
절대 요약하지 말 것. 짧은 답변은 품질 기준 미달로 재작성된다.

1. 모든 텍스트 필드는 각각 최소 300자 이상 작성한다.
...
{{
  "agency_policy":             "최소 300자. 미션·예산·조직 규모·홍보 성향 포함.",
  "leadership_message":        "최소 300자. 기관장 발언·키워드·올해 과제 포함.",
  "existing_content":          "최소 300자. 유튜브 현황·성공/실패 사례·문제점 포함.",
  "best_cases":                "최소 300자. 4개 이상 사례·수치·적용 포인트 포함.",
  "content_trends":            "최소 300자. 트렌드·포맷 변화·수치 포함.",
  "competitor_patterns":       "최소 300자. 낙찰 패턴·심사 기준·클리셰 포함.",
  "target_media_habits":       "최소 300자. 플랫폼별 소비 시간·완주율 포함.",
  "target_content_preference": "최소 300자. 반응 형식·바이럴 사례·썸네일 패턴 포함.",
  "platform_patterns":         "최소 300자. 플랫폼별 최적 길이·게시 시간·수치 포함.",
  "policy_changes":            "최소 300자. 관련 법령·고시·예산 지침 변화 포함.",
  "algorithm_trends":          "최소 300자. 2024-2025 알고리즘 변화·수치 포함.",
  "market_pricing":            "최소 300자. 편당 단가 범위·예산 전략·비용 구조 포함."
}}"""
