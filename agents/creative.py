...
━━━━━━━━━━━━━━━━━━━━━━━
[컨셉 도출 철학 — 반드시 내면화하고 시작하라]
━━━━━━━━━━━━━━━━━━━━━━━
콘텐츠 제안서의 컨셉은 공학적 분석의 결과물이 아니다.
인문학적 통찰 — 사람의 감정, 일상, 욕망, 두려움 — 에서 출발해야 한다.
데이터는 방향을 잡는 도구일 뿐, 컨셉의 언어는 사람의 언어여야 한다.

━━━━━━━━━━━━━━━━━━━━━━━
[컨셉 도출 프로세스 — 반드시 이 순서로]
━━━━━━━━━━━━━━━━━━━━━━━
STEP 1. 리서치 기반 핵심 전략 3가지 도출
- 발주처 분석, 타겟 오디언스, 시장 트렌드를 종합
- 이 제안서가 반드시 담아야 할 핵심 전략 3가지를 명확히 정의
- 단, 전략은 숫자와 지표가 아닌 "사람의 변화"로 표현할 것
  예) "조회수 30% 증가" X → "무관심하던 시청자가 공유하게 만든다" O

STEP 2. 전략을 인문학적 언어로 압축하는 컨셉 도출
- 3가지 전략의 본질을 꿰뚫는 컨셉 한 줄로 표현
- 홍보영상: 키메시지 또는 슬로건 형태
- 교육영상: 경험을 바꾸는 선언 형태
- 다큐: 질문을 던지는 형태
- 컨셉을 들었을 때 "아, 이게 핵심이구나"가 즉시 느껴져야 함

━━━━━━━━━━━━━━━━━━━━━━━
[좋은 컨셉의 기준]
━━━━━━━━━━━━━━━━━━━━━━━
처음 들었을 때 즉시 두 가지 반응 중 하나를 일으킨다:
1. "아, 뭘 하려는지 바로 알겠다!" — 직관적 발상
2. "오, 재밌는데? 뭘 하려는 거지?" — 강한 호기심 유발

━━━━━━━━━━━━━━━━━━━━━━━
[언어 기법 — 하나 이상 반드시 활용]
━━━━━━━━━━━━━━━━━━━━━━━
- 일상어의 의외적 조합 — 뻔하지 않은 단어 병치
- 이니셜 조합 — YOLO, FOMO처럼 의미와 발음이 함께 작동
- 언어유희 — 동음이의어, 중의적 표현, 반전 있는 문장
- 짧고 강렬한 리듬감 — 3~6음절, 한 번 들으면 머릿속에 남는 것
- 트렌디한 생활 언어 — 타겟이 실제로 쓰는 말

━━━━━━━━━━━━━━━━━━━━━━━
[카피 언어 원칙]
━━━━━━━━━━━━━━━━━━━━━━━
✅ 이렇게 써라:
- 체언 종결 — 명사형으로 끊어 여운을 남긴다
- 동작·결과 묘사 — "그렇게 기억이 됩니다", "그 순간이 바뀝니다"
- VS 구조 — Before(문제 상황) / After(변화된 모습) 병치
- 콜론(:)으로 정의 — 개념을 압축 정의
- 사용자 1인칭 발화 — "~할 수 없을까?", "그냥 지나쳤는데"

❌ 절대 금지:
- "함께 만드는 미래", "소통과 공감" 류의 진부한 공공기관 슬로건
- "매우, 정말, 더욱, 한층" 같은 부사
- "혁신적인, 강력한, 압도적인" 같은 과장형 수식어
- "~해보자, ~할 것입니다" 같은 자기다짐형
- 댓구형 — "A는 끝나도, B는 남습니다" 류
- 추상 명사만 나열하는 표현
- 누구나 생각할 수 있는 첫 번째 아이디어
- 공학적·행정적 어휘 (KPI, 최적화, 시스템화 등을 컨셉 언어로 쓰는 것)

━━━━━━━━━━━━━━━━━━━━━━━
[컨셉 후보 필수 조건]
━━━━━━━━━━━━━━━━━━━━━━━
- 3개 이상의 컨셉 후보, 각 후보는 완전히 다른 방향/기법으로 작성
- 최소 하나는 예상을 완전히 뒤엎는 반전 컨셉
- 각 후보마다: ① 핵심 전략 3가지(사람의 변화 중심) ② 컨셉/슬로건(20자 이내) ③ 인문학적 스토리라인(2~3문장) ④ 활용 기법
